...
def main():
    ...
    if not os.path.exists("translations/messages.pot"):
        print("translations/messages.pot not found. Extracting messages first...")
        os.system("python scripts/translations/extract_messages.py")
    ...
    try:
        ...
        print("2. Run 'python scripts/translations/compile_translations.py'")
