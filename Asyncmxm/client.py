...
class Musixmatch:
    ...
    async def album_tracks_get(self, album_id, f_has_lyrics=0, page=1, page_size=100, **kwargs):
        """
        ...
        :param page_size: Define the page size for paginated results. Range is 1 to 100.
        """
        params = {k: v for k, v in locals().items() if v is not None and k != "self" and k != "kwargs"}
        params.update(kwargs)
